...
class AccountStorageTest {
    ...
    @Test
    void whenTransferAndAccountIsAbsent() {
        var storage = new AccountStorage();
        storage.add(new Account(2, 100));
        assertThatIllegalStateException()
                .isThrownBy(() -> storage.transfer(1, 2, 100))
                .withMessage("Not found account by id = 1");
        var secondAccount = storage.getById(2)
                .orElseThrow(() -> new IllegalStateException("Not found account by id = 2"));
    ...
    @Test
    void whenTransferAndFromIsLess() {
        var storage = new AccountStorage();
        ...
        assertThatIllegalStateException()
                .isThrownBy(() -> storage.transfer(1, 2, 100))
                .withMessage("Not enough money by id = 1");
